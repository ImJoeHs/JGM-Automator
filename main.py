...
if __name__ == '__main__':
    ...
    up_list = [(5, 1)]  # 这个号建筑升级1次， 那个号建筑升级1次
    # 收货过滤列表
    harvest_filter = [1, 2, 4, 5, 7, 8]  # 收取这些号建筑的货物
    # adb设备列表
    Device1 = 'QV7039V30X'
    Device2 = 'CB512BC4ZL'
    Device1Net = '10.21.20.105'
    Device2Net = '10.21.59.70'
    MuMu = 'localhost:22471'
    ...
    instance = Automator(MuMu, up_list, harvest_filter,
                         auto_policy=policy, auto_task=task, speedup=speed_up)
    # 启动脚本。
    instance.start()
